...
export default class Dashboard extends React.Component {
  ...
  // TODO: add handleRemoveExpense here
      ...
      <ul>
        {
          this.state.expenses.map((expense) => {
            return (
              <li key={expense._id}>
                {/* TODO: plug in Expense Item here */}
                <ExpenseItem 
                  expense={expense}
  ...
  render() {
    return (
      <section className="dashboard">
        ...
        {/* TODO: bring in renderIf method here */}
        { 
          renderIf(this.state.error, <h1 className="error">You must enter a title</h1>)
        }
